...
angular.module('app', ['ngResource', 'ngRoute','geocoder-service','ui.bootstrap','ngAnimate','ngTouch', 'ui.grid', 'ui.grid.pagination','ngTouch', 'ui.grid.exporter', 'ui.grid.selection']);
